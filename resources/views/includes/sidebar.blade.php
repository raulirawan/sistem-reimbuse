    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            ...
            @if (Auth::user()->roles == 'KARYAWAN')
                @include('includes.sidebar.karyawan')
            @endif
            {{-- end sid bar karyawan --}}

            {{-- sidebar karyawan --}}
            @if (Auth::user()->roles == 'KEUANGAN')
                @include('includes.sidebar.keuangan')
            @endif
            {{-- end sid bar karyawan --}}

            {{-- sidebar karyawan --}}
            @if (Auth::user()->roles == 'PARTNER')
                @include('includes.sidebar.partner')
            @endif
            {{-- end sid bar karyawan --}}

            {{-- sidebar karyawan --}}
            @if (Auth::user()->roles == 'SEKRETARIS')
                @include('includes.sidebar.sekretaris')
            @endif
            {{-- end sid bar karyawan --}}
        </div>
    </div>
