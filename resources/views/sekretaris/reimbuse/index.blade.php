                                ...
                                @foreach ($reimbuse as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('sekretaris.reimbuse.show', $item->id) }}"
            ...
            <form action="#" id="form-approve" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel1">Form Approve Data Reimburse</h5>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="catatan_sekretaris" id="catatan_sekretaris" class="form-control" placeholder="Masukan Catatan"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade text-left" id="modal-reject" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <form action="#" id="form-reject" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel1">Form Reject Data Reimburse</h5>
                        <button type="button" class="close rounded-pill" data-bs-dismiss="modal" aria-label="Close">
                            <i data-feather="x"></i>
                        </button>
                    </div>
        ...
        <script>
            $(document).ready(function() {
                $(document).on('click', '#approve', function() {
                    var id = $(this).data('id');
                    $('#form-approve').attr('action', '/sekretaris/reimbuse/approve/' + id);
                });

                $(document).on('click', '#reject', function() {
                    var id = $(this).data('id');
                    $('#form-reject').attr('action', '/sekretaris/reimbuse/reject/' + id);
                });
            });
        </script>
    @endpush
