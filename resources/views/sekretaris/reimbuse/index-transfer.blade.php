                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-success badge" id="approve"
                                                ...
                                                data-bs-target="#modal-approve">Upload Bukti Transfer</button>
                                        </td>
                                    </tr>
                                @endforeach
            ...
            <form action="#" id="form-approve" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel1">Form Upload Bukti Transfer</h5>
        ...
        <script>
            $(document).ready(function() {
                $(document).on('click', '#approve', function() {
                    var id = $(this).data('id');
                    $('#form-approve').attr('action', '/sekretaris/reimbuse/transfer/' + id);
                });
            });
        </script>
    @endpush
